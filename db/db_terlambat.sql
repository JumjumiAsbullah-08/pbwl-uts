...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2022 at 05:34 AM
...
(9, 'Arnida Siregar', 'Perempuan'),
(10, 'Saparuddin Siregar', 'Laki-Laki'),
(11, 'Anna Delila', 'Perempuan'),
(12, 'Derliana Pane', 'Perempuan');
...
(10, 'Jumjumi Asbullah Harahap', 'Jl. Padang Sidempuan No. 18 Kel. Rambung Barat Kota Binjai', 'Laki-Laki', 'XII-IPA1', 'IPA'),
(11, 'Nihlan Juniar Siregar', 'Jl. Asahan No. 12', 'Perempuan', 'XII-IPA3', 'IPA'),
(12, 'Endar Muda', 'Jl. Padang Sidempuan No. 18 Kel. Rambung Barat Kota Binjai', 'Laki-Laki', 'X-5', 'IPA'),
(13, 'Luthfi Taftazani', 'Desa Pangirkiran', 'Laki-Laki', 'X-1', 'IPA'),
(14, 'Alzuhair', 'Jl. Asahan No. 12', 'Laki-Laki', 'XII-IPS3', 'IPS');
...
(17, 10, 12, '2022-05-17', '2022-05-17', '08:18:44', '08:30:44', 'Menyapu Ruang UKS', 'Ban Bocor'),
(18, 12, 10, '2022-05-18', '2022-05-18', '08:07:44', '08:31:44', 'Membersihkan WC', 'Terlambat Bangun Tidur'),
(19, 13, 9, '2022-05-17', '2022-05-17', '09:00:24', '09:20:24', 'Membersihkan Taman Sekolah', 'Habis Minyak');
...
--
ALTER TABLE `tbl_piket`
  MODIFY `id_piket` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_terlambat`
  MODIFY `id_terlambat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
